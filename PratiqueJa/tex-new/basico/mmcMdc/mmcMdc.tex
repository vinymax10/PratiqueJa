...
MDC $= 1$ — não compartilham nenhum fator primo.}
\exemp{%
  MDC$(9,16) = 1$: \ $9=3^2$, $16=2^4$ \ok\\
  MDC$(35,48) = 1$: \ $35=5\cdot7$, $48=2^4\cdot3$ \ok%
}

\SH{Casos especiais}
\exemp{%
  \textbf{Consecutivos} são sempre coprimos:\\
  MDC$(13,14) = \hlm{1}$\\[3pt]
  \textbf{Se $a$ divide $b$:} MDC$(a,b)=a$ e MMC$(a,b)=b$\\
