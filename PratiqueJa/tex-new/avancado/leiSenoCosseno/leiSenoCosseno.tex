...
\vspace{-6pt}\begin{center}\vspace{-6pt}
\begin{tikzpicture}[scale=0.72]
  ...
  % ângulo A
  \draw[darkblue,thick] (0.45,0) arc (0:41:0.45);
  \node[font=\scriptsize, darkblue] at (0.66,0.2) {$A$};
\end{tikzpicture}
\vspace{-10pt}\end{center}
...
$c = \dfrac{7 \cdot 0{,}9686}{0{,}5} \hlm{ \approx 13{,}56}$
