...
A área de um polígono representa uma medida do preenchimento da região interna do polígono. Existe uma grande variedade de polígonos e diversas maneiras para determinar o valor de cada área. O perímetro de um de polígono é a soma de todos os seus lados. Ou seja, é a medida do comprimento total do contorno da figura. Apresentamos a seguir uma formulação para o cálculo da área e do perímetro dos principais polígonos. 
...
Dado um paralelogramo com base $b=5$ e altura $h=2$ temos:

$A = 5 \cdot 2 = 10$

Se tivermos um paralelogramo com base $b=6$ e lado $a=4$, então o perímetro é calculado por:
...
O cálculo do perímetro do trapézio é dado pela soma dos seus quatro dados conforme indicado na figura abaixo:
...
Dado um trapézio com base maior $B=7$, base menor $b=3$ e altura $h=2$ temos:

\vspace{8px}
$A = \dfrac{(7 + 3) \cdot 2}{2} =  \dfrac{10 \cdot 2}{2} = 10$ \vspace{8px}

Considerando um trapézio com os lados $a=6$, $b=3$, $c=4$ e $d=4$, temos o perímetro dado por:
...
Dado um losango com diagonal maior $D=6$ e diagonal menor $d=4$ temos:

\vspace{8px}
$A = \dfrac{6 \cdot 4}{2} =\dfrac{24}{2} = 12$ \vspace{8px}

O perímetro de um losango com lado $l=5$ é $P=4 \cdot 5= 20$.
...
O comprimento de uma circunferência com raio $r=5$ é $C=2\cdot \pi \cdot 5 = 10 \pi$.
