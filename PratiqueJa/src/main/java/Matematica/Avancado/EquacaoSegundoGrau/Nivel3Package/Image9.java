...
public class Image9 extends Conta
{
	...
	public Image9(int indice)
	{
		...
		pergunta = "Encontre \\(a\\), dado \\( f(x)=" + "ax^2" + Auxiliar.getNumber(dadosEq2Grau.b, "x", false) 
		+ Auxiliar.getNumber(dadosEq2Grau.c, "", false)+" \\)";
		
		resolucaoLatex=ResolucaoEq2Grau.resolucaoAXv(dadosEq2Grau.a,dadosEq2Grau.b,dadosEq2Grau.c,dadosEq2Grau.xVerticeRacional);
