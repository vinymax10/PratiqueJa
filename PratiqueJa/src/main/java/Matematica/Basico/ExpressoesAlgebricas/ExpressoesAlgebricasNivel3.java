...
import Matematica.Basico.ExpressoesAlgebricas.Nivel3Package.*;

@Entity
public class ExpressoesAlgebricasNivel3 extends Conta
{
	private static final long serialVersionUID = 1L;

	public ExpressoesAlgebricasNivel3(int index)
	{
		super(index);
	...
	public ExpressoesAlgebricasNivel3()
	{
