...
public class Config4 extends Config
{
	...
	public Config4(String lateralEsq, String centro, String lateralDir)
	{
		super();
	...
	public BufferedImage criarImagem(int index)
	{
		...
		Line2D line2 = new Line2D.Double(600, 112, 80, 560);
		g2.draw(line2);

		Line2D line3 = new Line2D.Double(140, 120, 80, 560);
		g2.draw(line3);

		Line2D line4 = new Line2D.Double(140, 120, 600, 112);
		g2.draw(line4);
		...
		Graphics.addLabel(g2, lateralEsq, 180 , 180, Alinhamento.TopLeft);
		
		Graphics.addLabel(g2, centro, 530, 112 + raio / 2, Alinhamento.TopCenter);
