...
public class Image11 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		String pergunta = "Se a \\(tan~" + angle + "=" + dados.tagAngleBase.showDfrac() + "\\), qual o valor de x?";

		String resultadoCorreto = "" + dados.base;
		String resolucao = ResolucaoRazoesTrigonometricas.tagCOX(angle, dados.tagAngleBase, dados.altura);
