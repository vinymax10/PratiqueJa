...
public class Config6 extends Config
{
	...
	public BufferedImage criarImagem(int index)
	{
		...
		Graphics.setLineTracejada(g2, xIni, yFim+deslocamentoTracejada, 
		centroX, yFim+deslocamentoTracejada, true, true);
		Graphics.addLabel(g2, dados.base.str, xIni+(base/2), yFim+deslocamentoTracejada, Alinhamento.TopCenter);
