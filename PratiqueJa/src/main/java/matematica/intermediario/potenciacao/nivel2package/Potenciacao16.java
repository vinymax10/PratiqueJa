...
public class Potenciacao16 extends GeradorExercicio
{
	@Override
	protected void construir()
	{
		...
		setResolucao("\\(" + ResolucaoPotencia.resolucaoPotenciaNegativa((int) racional.numerador, (int) racional.denominador, p) + "\\)");
	}
}
