...
import matematica.intermediario.expressaoalgebrica.nivel3package.*;

@Entity
public class ExpressaoAlgebricaNivel3 extends Conta
{
	private static final long serialVersionUID = 1L;

	public ExpressaoAlgebricaNivel3(int index)
	{
		super(index);
	...
	public ExpressaoAlgebricaNivel3()
	{
