...
// Graph: parabola opening UP (a > 0).  Asks where f(x) > 0  →  outside the roots.
public class Image2 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		String correta = "\\(x \\in (-\\infty,\\," + r1 + fecha + " \\cup " + abre + r2 + ",\\,+\\infty)\\)";
		...
		addResolucao("A parábola abre para cima (\\(a=" + a + ">0\\)): \\(f(x)" + sinal + "0\\) fora das raízes" + (strict ? "." : " (incluindo os zeros)."));
