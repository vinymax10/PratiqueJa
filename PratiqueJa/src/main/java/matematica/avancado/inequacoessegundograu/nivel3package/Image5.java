...
// Graph: parabola opening UP (a > 0), one negative root.  Asks where f(x) < 0  →  between roots.
public class Image5 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		addResolucao("A parábola abre para cima (\\(a=" + a + ">0\\)): \\(f(x)" + sinal + "0\\) entre as raízes" + (strict ? "." : " (incluindo os zeros)."));
