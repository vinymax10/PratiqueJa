...
// Graph: parabola opening DOWN (a < 0).  Asks where f(x) > 0  →  between the roots.
public class Image3 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		addResolucao("A parábola abre para baixo (\\(a=" + a + "<0\\)): \\(f(x)" + sinal + "0\\) entre as raízes" + (strict ? "." : " (incluindo os zeros)."));
