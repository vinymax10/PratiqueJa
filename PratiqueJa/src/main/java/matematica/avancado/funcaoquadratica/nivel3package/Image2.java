...
public class Image2 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		addParagrafo("Encontre a coordenada \\(y_v\\) do vértice");
		addParagrafo("\\(" + funcao + "\\)");
		addParagrafoImagem(image);
		gerarAlternativas(dados.yVerticeRacional);
		for(String passo : ResolucaoFuncaoQuadratica.resolucaoYv(dados.a, dados.b, dados.c))
			addResolucao(passo);
	}
}
