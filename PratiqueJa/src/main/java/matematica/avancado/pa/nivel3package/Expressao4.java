...
public class Expressao4 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		String enunciado = "" + a1.showDfrac() + ", " + ResolucaoPA.a(a1, r, 2).showDfrac() + ", x, " + ResolucaoPA.a(a1, r, 4).showDfrac() + "";

		addParagrafo("Qual o valor de \\(x\\)?");
		addParagrafo("\\(" + enunciado + "\\)");
		gerarAlternativas(ResolucaoPA.a(a1, r, 3).toString());
		for(String passo : ResolucaoPA.x3(a1, r))
			addResolucao("\\(" + passo + "\\)");
	}
}
