	...
	protected void construir()
	{
		...
		switch (choice) {
			case 0:
				...
				resultado   = 1;
				resolucaoCalc = "\\(\\dfrac{1}{2}\\cdot\\dfrac{1}{2} + \\dfrac{\\sqrt{3}}{2}\\cdot\\dfrac{\\sqrt{3}}{2} = \\\\"
						+ "\\dfrac{1}{4} + \\dfrac{3}{4} = \\mathbf{1}\\)";
				break;
			case 1:
				expressao   = "\\((\\operatorname{sen}(60°) + \\cos(30°))^2\\)";
				resultado   = 3;
				resolucaoCalc = "\\(\\left(\\dfrac{\\sqrt{3}}{2} + \\dfrac{\\sqrt{3}}{2}\\right)^2 = \\\\"
						+ "(\\sqrt{3})^2 = \\mathbf{3}\\)";
				break;
			case 2:
				expressao   = "\\(\\operatorname{tg}^2(45°) + \\cos(180°) + \\operatorname{sen}(270°)\\)";
				resultado   = -1;
				resolucaoCalc = "\\(1^2 + (-1) + (-1) = 1 - 1 - 1 = \\mathbf{-1}\\)";
				break;
			default:
				expressao   = "\\(\\operatorname{tg}(45°)\\cdot(1 - \\cos(180°)) + \\operatorname{sen}(0°)\\)";
				resultado   = 2;
				resolucaoCalc = "\\(1\\cdot(1 - (-1)) + 0 = \\\\"
						+ "1\\cdot 2 = \\mathbf{2}\\)";
				break;
		}
