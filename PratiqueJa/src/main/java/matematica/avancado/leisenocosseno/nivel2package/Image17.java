...
public class Image17 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		Racional r = dados.ladoB.div(new Racional(2).mult(dados.senAngleB));
		r.fatoracao(2);
		String resultadoCorreto = r.toString();
		String resolucao = Resolucao.raioCircunscrito(angle, dados.ladoB, dados.senAngleB);

		BufferedImage image = config.criarImagem();

		addParagrafo("Sabendo que \\(\\text{sen}~" + angle + " = " + dados.senAngleB.showDfrac()
