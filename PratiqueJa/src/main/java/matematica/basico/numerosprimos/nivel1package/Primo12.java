...
public class Primo12 extends AgrupadorPrimo
{
	...
	protected void construir()
	{
		...
		addResolucao("Todo número par maior que \\(2\\) é divisível por \\(2\\), além de \\(1\\) e dele mesmo.");
		addResolucao("\\(" + n + " \\div 2 = " + (n / 2) + "\\), então tem o divisor \\(2\\).");
		addResolucao("Logo, não é primo: \\(\\mathbf{Não}\\). (O \\(2\\) é o único número primo par.)");
	}
}
