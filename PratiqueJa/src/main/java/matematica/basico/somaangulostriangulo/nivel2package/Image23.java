...
public class Image23 extends GeradorExercicio
{
	...
	private String[] resolucao(int a, int b, int c, int d, int e, int f, int g)
	{
		...
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("y", d, e));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("z", c));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("x", b, 90));
