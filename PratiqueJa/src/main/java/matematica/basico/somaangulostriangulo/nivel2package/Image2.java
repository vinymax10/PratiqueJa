...
public class Image2 extends GeradorExercicio
{
	...
	private String[] resolucao(int a, int b, int c, int d, int e)
	{
		...
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("z", c, 90));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento90("y", e));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("x", a, d));
