...
public class Image26 extends GeradorExercicio
{
	...
	private String[] resolucao(int a, int b, int c, int d, int e, int f, int g)
	{
		...
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("y", a, 90));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("z", b));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("x", c, e));
