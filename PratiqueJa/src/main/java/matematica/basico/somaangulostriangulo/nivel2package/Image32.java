...
public class Image32 extends GeradorExercicio
{
	...
	private String[] resolucao(int a, int b, int c, int d, int e, int f, int g)
	{
		...
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("y", b, 90));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento90("z", a, e));
		java.util.Collections.addAll(passosLista, ResolucaoSAT2.complemento180("x", f, 90));
