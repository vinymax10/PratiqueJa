...
// Dois descontos percentuais sucessivos
public class RegraTres14 extends GeradorExercicio
{
	...
	protected void construir()
	{
		...
		addParagrafo("Um produto sofreu dois descontos sucessivos de \\(" + p1 + "\\%\\) e \\(" + p2 + "\\%\\). Qual o percentual de desconto total equivalente?");
