...
// Variação percentual entre dois valores (terceira variação)
public class RegraTres14 extends GeradorExercicio
{
	private static final String[] TEXTOS_AUMENTO = {
		"As vendas subiram de $A para $B unidades em um mês. Qual o percentual de aumento?",
		"O seguidor de um perfil passou de $A para $B mil. Qual o percentual de crescimento?",
		"A nota de um aluno subiu de $A para $B pontos. Qual o percentual de aumento?",
	};

	private static final String[] TEXTOS_REDUCAO = {
		"O peso de uma pessoa caiu de $A para $B kg. Qual o percentual de redução?",
		"O gasto mensal diminuiu de R$$A,00 para R$$B,00. Qual o percentual de redução?",
		"A quantidade de erros caiu de $A para $B. Qual o percentual de redução?",
	};
