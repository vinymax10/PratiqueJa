...
public class Expressao12 extends Conta
{
	private static final long serialVersionUID = 1L;

	public Expressao12(int indice)
	{
		super(indice);
...
//		-------------------------		
		...
		textLatex = "\\dfrac{" + coeficientes[0] + ope1 + "(" + coeficientes[1] + ope2 + coeficientes[2] + ")}{(" + coeficientes[3] + ope4 + coeficientes[4]
		+ ")" + ope5 + coeficientes[5] + "}";
