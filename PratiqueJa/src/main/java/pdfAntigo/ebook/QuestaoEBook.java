...
public class QuestaoEBook
{
	...
	public QuestaoEBook(Diretorio diretorioBean)
	{
		super();
		this.diretorioBean=diretorioBean;
	}

	public void gerarPDFQuestoes(List<Questao> questoes)
	{
	...
	public void cabecalho()
	{
		...
		+"\\BB{\\Large Questões } & \\footnotesize "
		+ "\\BI{Módulo "+moduloTexto+"}"
		+" \\BL{-} \\BV{"+assuntoTexto +"} & Nota:    \\\\  \r\n" 
		+"\\end{tabular}\r\n" 
		+ "\\vspace{0.3cm}\r\n" 
		+"\r\n" ;
	}
	
	public void cabecalhoResolucao()
	{
		latex+=	
		"\\setstretch{1} \r\n" 
		+"\\normalsize \r\n" 
	...
	public void listaQuestoes()
	{
		...
		for(int i = 0; i < questoes.size(); i++)
		{
			...
			latex+="\\scriptsize \\BL{"+(i+1)+")} \\BB{Q"+questao.getId()+"} \\BB{Ano:}"
