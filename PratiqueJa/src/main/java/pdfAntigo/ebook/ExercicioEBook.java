...
public class ExercicioEBook
{
	...
	public void gerarPDFExercicio(ExercicioPadrao exercicio)
	{
...
//			rodape(pagina+1);
	...
	{
		double alturaTotal = (double)(24+((6-(listaContas.size()/2))*0.2))/(listaContas.size()/2);
