...
public class GerarLatexExercicio
{
	...
	public void cabecalho()
	{
		...
		+ "\\textcolor{iris}{Módulo "+exercicio.getAssuntoCurso().getModulo().getNome()+"}"
		+" \\BL{-} \\textcolor{verde}{Assunto "+exercicio.getAssuntoCurso().getNome() +"} "
	...
	public void rodape()
	{
		...
		+"\\BL{-} Nível "+exercicio.getNivelRomano()+" \r\n "
//		+ "
//		+ "\\BI{"+exercicio.getAssuntoCurso().getModulo().getNome()+"} "
//		+"\\BC{-} \\BV{"+exercicio.getAssuntoCurso().getNome()+"} \\BL{-} \\BC{"+exercicio.getNivelRomano()+"} \r\n" 
		+"\\vspace{0.2cm}\r\n" 
		+"\r\n" 
		+"\\scriptsize\r\n";
