...
import pdf.base.Cabecalho;
import pdf.base.PdfStyle;
import pdf.base.Rodape;

public class HeaderAuditoria extends PdfPageEventHelper
{
	...
	{
		Cabecalho.criarCabecalho(document,"Relatório de Auditoria");
	}
